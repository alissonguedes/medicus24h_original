<aside id="right-sidebar-nav">
	<div class="row">
		<div class="col s9 l3">
			<div id="atendimento" class="slide-out-right-sidenav sidenav rightside-navigation" data-position="right">
				<div class="row">
					...
					<div class="slide-out-right-body row pl-3">
						<div id="messages" class="col s12 pb-0">
							<div class="collection border-none mb-0">
								...
								<ul class="collection right-sidebar-chat p-0 mb-0 scroller" style="height: calc(100vh - 65px);">
						...
						<div id="settings" class="col s12 scroller" style="height: calc(100vh - 65px);">
						...
						<div id="activity" class="col s12 scroller" style="height: calc(100vh - 65px);">
							<div class="activity">
		...
		<!-- Slide Out Chat -->
		<ul id="slide-out-chat" class="sidenav slide-out-right-sidenav-chat" data-position="right">
			<li class="center-align pt-2 pb-2 sidenav-close chat-head">
				<a href="#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth Elliott</a>
			</li>
			<li class="chat-body scroller" style="height: calc(100vh - 150px);">
				<ul class="collection">
