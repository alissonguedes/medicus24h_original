...
<button class="btn btn-floating gradient-45deg-deep-orange-orange waves-effect waves-light z-depth-3" data-url="<?php echo e(go('clinica.funcionarios.add')); ?>" data-trigger="modal" data-target="modal_funcionario" data-tooltip="<?php echo $__env->yieldContent('btn-add-title'); ?>" data-position="left" data-href="<?php echo $__env->yieldContent('btn-add-route'); ?>">
...
<?php echo $__env->make('clinica.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alissonp/www/cliniccloud-main/application/resources/views/clinica/funcionarios/index.blade.php ENDPATH**/ ?>